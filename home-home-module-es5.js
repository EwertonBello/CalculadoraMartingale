...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.calcularSobrePerda = function () {
        var resultado = (this.perda1 + this.adicional1) / (this.rendimento1 / 100);
        this.resultado1 = resultado;
    };
    HomePage.prototype.calcularMartingales = function () {
        var valor_inicial = (this.lucro) / (this.rendimento2 / 100);
        var cont = 1;
        var total_martingale = valor_inicial;
        var niveis = "Investimento " + cont + ": " + valor_inicial;
        while (this.banca >= total_martingale) {
            cont += 1;
            var nivel_atual = ((total_martingale + this.lucro) / (this.rendimento2 / 100));
